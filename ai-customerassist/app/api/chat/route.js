...
const YOUR_SITE_URL = process.env.YOUR_SITE_URL || 'http://localhost:3000' || 'https://ai-customer-assist-5jdd.vercel.app/'; // Set to your local site URL
const YOUR_SITE_NAME = process.env.YOUR_SITE_NAME || 'Web Site'; // Set to your local site name
